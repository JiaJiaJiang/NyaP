...
class NyaPlayerCore extends NyaPEventEmitter {
	constructor(opt) {
		...
		this.videoFrame = (0, _Object2HTML2.default)({ _: 'div', attr: { id: 'video_frame' }, child: [this.video,
			//this.container,
		...
		if (this._danmakuEnabled) {
			this.danmakuContainer = (0, _Object2HTML2.default)({ _: 'div', prop: { id: 'danmaku_container' } });
	...
	constructor(opt) {
		...
		if (this._danmakuEnabled) {
			...
			opt.danmakuSizes && opt.danmakuSizes.forEach((s, ind) => {
				let e = (0, _Object2HTML2.default)({ _: 'span', attr: { style: `font-size:${16 + ind * 3}px;`, title: s }, prop: { size: s }, child: ['A'] });
...
class MsgBox {
	...
	setText(text) {
		this.msg.innerHTML = '';
		let e = (0, _Object2HTML.Object2HTML)(text);
